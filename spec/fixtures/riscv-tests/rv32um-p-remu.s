...
.section .text.init; .align 6; .weak mtvec_handler; .globl _start; _start: j reset_vector; .align 2; trap_vector: csrr t5, mcause; li t6, 0xb; beq t5, t6, write_tohost; li t6, 0x8; beq t5, t6, write_tohost; li t6, 0x9; beq t5, t6, write_tohost; la t5, mtvec_handler; beqz t5, 1f; jr t5; 1: ori gp, gp, 1337; write_tohost: sw gp, tohost, t5; sw zero, tohost + 4, t5; j write_tohost; reset_vector: li gp, 0; la t0, trap_vector; csrw mtvec, t0; init;
  ...
  # Arithmetic tests
  #-------------------------------------------------------------
  test_2: li gp, 2; li x11, ((20) & ((1 << (32 - 1) << 1) - 1)); li x12, ((6) & ((1 << (32 - 1) << 1) - 1)); remu x14, x11, x12;; li x7, ((2) & ((1 << (32 - 1) << 1) - 1)); bne x14, x7, fail;;
  test_3: li gp, 3; li x11, ((-20) & ((1 << (32 - 1) << 1) - 1)); li x12, ((6) & ((1 << (32 - 1) << 1) - 1)); remu x14, x11, x12;; li x7, ((2) & ((1 << (32 - 1) << 1) - 1)); bne x14, x7, fail;;
  test_4: li gp, 4; li x11, ((20) & ((1 << (32 - 1) << 1) - 1)); li x12, ((-6) & ((1 << (32 - 1) << 1) - 1)); remu x14, x11, x12;; li x7, ((20) & ((1 << (32 - 1) << 1) - 1)); bne x14, x7, fail;;
  test_5: li gp, 5; li x11, ((-20) & ((1 << (32 - 1) << 1) - 1)); li x12, ((-6) & ((1 << (32 - 1) << 1) - 1)); remu x14, x11, x12;; li x7, ((-20) & ((1 << (32 - 1) << 1) - 1)); bne x14, x7, fail;;
  test_6: li gp, 6; li x11, ((-1<<31) & ((1 << (32 - 1) << 1) - 1)); li x12, ((1) & ((1 << (32 - 1) << 1) - 1)); remu x14, x11, x12;; li x7, ((0) & ((1 << (32 - 1) << 1) - 1)); bne x14, x7, fail;;
  test_7: li gp, 7; li x11, ((-1<<31) & ((1 << (32 - 1) << 1) - 1)); li x12, ((-1) & ((1 << (32 - 1) << 1) - 1)); remu x14, x11, x12;; li x7, ((-1<<31) & ((1 << (32 - 1) << 1) - 1)); bne x14, x7, fail;;
  test_8: li gp, 8; li x11, ((-1<<31) & ((1 << (32 - 1) << 1) - 1)); li x12, ((0) & ((1 << (32 - 1) << 1) - 1)); remu x14, x11, x12;; li x7, ((-1<<31) & ((1 << (32 - 1) << 1) - 1)); bne x14, x7, fail;;
  test_9: li gp, 9; li x11, ((1) & ((1 << (32 - 1) << 1) - 1)); li x12, ((0) & ((1 << (32 - 1) << 1) - 1)); remu x14, x11, x12;; li x7, ((1) & ((1 << (32 - 1) << 1) - 1)); bne x14, x7, fail;;
  test_10: li gp, 10; li x11, ((0) & ((1 << (32 - 1) << 1) - 1)); li x12, ((0) & ((1 << (32 - 1) << 1) - 1)); remu x14, x11, x12;; li x7, ((0) & ((1 << (32 - 1) << 1) - 1)); bne x14, x7, fail;;
